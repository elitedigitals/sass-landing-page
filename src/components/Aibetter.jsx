  ...
  return (
    <div className="mt-10">
        <div className="text-center mb-4">
            ...
            <p className="text-slate-300">Cyberplan Ai stands out from traditional project management tools by integrating cutting-edge AI technology to provide intelligent insights, automate routine tasks, and enhance collaboration among team members.</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 rounded-lg mx p-4 gap-4">
            {better.map((item, index) => (
                <div key={index} className="flex flex-col items-center justify-center gap-2  bg-purple-900/30 backdrop-blur-md rounded-lg shadow-lg shadow-purple-900/20 p-4">
